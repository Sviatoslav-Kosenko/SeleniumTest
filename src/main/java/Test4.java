...
//Построение маршрута для вида транспорта "Велосипед"
public class Test4 {
    public static void main(String[] args){
        ...
        element.click();
        WebElement element1 = driver.findElement(By.xpath("//div[@class='route-travel-modes-view__mode _mode_bicycle']"));
        element1.click();
