...
//Построение маршрута для вида транспорта "Пешком"
public class Test3 {
    public static void main(String[] args){
        ...
        element.click();
        WebElement element1 = driver.findElement(By.xpath("//div[@class='route-travel-modes-view__mode _mode_pedestrian']"));
        element1.click();
        ...
        WebElement element4 = driver.findElement(By.xpath("//div[@class='pedestrian-route-snippet-view__route-title-primary']"));
        System.out.println(element4.getText());
        WebElement element5 = driver.findElement(By.xpath("//div[@class='pedestrian-route-snippet-view__route-title-secondary']"));
