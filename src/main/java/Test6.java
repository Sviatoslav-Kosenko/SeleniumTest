...
//Построение маршрута для вида транспорта "Такси"
public class Test6 {
    public static void main(String[] args){
        ...
        WebElement element3 = driver.findElement(By.xpath("//div[@class='route-travel-modes-view__mode _mode_taxi']"));
        element3.click();
        WebElement element4 = driver.findElement(By.xpath("//div[@class='taxi-route-snippet-view__price']"));
        System.out.println(element4.getText());
        WebElement element5 = driver.findElement(By.xpath("//div[@class='taxi-route-snippet-view__duration']"));
